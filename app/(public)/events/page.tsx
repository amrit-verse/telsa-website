  ...
  return (
    <div className="container mx-auto px-4 py-10 md:py-16 max-w-6xl">
      <div className="text-center mb-12 md:mb-16">
        <h1 className="font-serif text-3xl md:text-5xl font-bold text-primary mb-4">TeLSA Events</h1>
      ...
      {upcomingEvents.length > 0 && (
        <section className="mb-16 md:mb-20">
          <h2 className="font-serif text-2xl md:text-3xl font-bold text-primary mb-6 md:mb-8 border-b pb-2">Upcoming Events</h2>
      ...
      {pastEvents.length > 0 && (
        <section>
          <h2 className="font-serif text-2xl md:text-3xl font-bold text-primary mb-6 md:mb-8 border-b pb-2">Past Events</h2>
...
function EventCard({ event }: { event: any }) {
  return (
    <div className="bg-card border border-border rounded-sm shadow-sm overflow-hidden flex flex-col hover:shadow-md transition-shadow">
      {event.imageUrl ? (
