...
export const PublicationCreateSchema = z.object({
  ...
  type: z.enum(["NOTES", "RESEARCH_PAPER", "LEGAL_ARTICLE", "MOOT_COURT", "REPORT", "NOTICE"], { message: "Type is required" }),
  summary: z.string().min(10, "Summary must be at least 10 characters"),
  content: z.string().min(20, "Content must be at least 20 characters"),
  author: z.string().min(2, "Author name is required"),
  publishedDate: z.coerce.date({ message: "Published date is required" }),
